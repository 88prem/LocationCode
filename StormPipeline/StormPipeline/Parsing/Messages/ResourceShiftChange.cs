...
{    
    ...
    public class ResourceShiftChange : IOperate
    {
        private readonly ILogger logger;
        private readonly StormMessageValidator stormMessageValidator;

        public ResourceShiftChange(ILogger logger, StormMessageValidator stormMessageValidator)
        {
            this.logger = logger;
        ...
        {
            logger.Information("RSC processed");
        ...
        {
            stormMessageValidator.ValidateDateTimeStampFieldFormat2(((Queue.MessageCodes.ResourceShiftChange)stormMetaData).NextEndShift);
        }
    }
}
