namespace Com.Apdcomms.StormPipeline.Parsing.Messages
{
    ...
    public class ProcessIncidentLogInformation : IOperate
    {
        private readonly ILogger logger;
        private readonly StormMessageValidator stormMessageValidator;

        public ProcessIncidentLogInformation(ILogger logger, StormMessageValidator stormMessageValidator)
        {
            this.logger = logger;
        ...
        {
            logger.Information("PILI processed");
        ...
        {
            stormMessageValidator.ValidateDateTimeStampFieldFormat2(((Queue.MessageCodes.ProcessIncidentLogInformation)stormMetaData).Timestamp);
        }
    }
}
