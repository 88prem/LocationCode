namespace Com.Apdcomms.StormPipeline.Parsing.Messages
{
    ...
    public class CreateResource : IOperate
    {
        private readonly ILogger logger;
        private readonly StormMessageValidator stormMessageValidator;

        public CreateResource(ILogger logger, StormMessageValidator stormMessageValidator)
        {
            this.logger = logger;
        ...
        {
            logger.Information("CR processed");
        ...
        {
            stormMessageValidator.ValidateUniquField(((Queue.MessageCodes.CreateResource)stormMetaData).Label);
            stormMessageValidator.ValidateUniquField(((Queue.MessageCodes.CreateResource)stormMetaData).Type);
            stormMessageValidator.ValidateAttributeField(stormMessage, mappingConfig);
            stormMessageValidator.ValidateDateTimeStampFieldFormat1(((Queue.MessageCodes.CreateResource)stormMetaData).UpdateTime);
        }
    }
}
