...
{    
    ...
    public class SetDataAttribute : IOperate
    {
        private readonly ILogger logger;
        private readonly StormMessageValidator stormMessageValidator;

        public SetDataAttribute(ILogger logger, StormMessageValidator stormMessageValidator)
        {
            this.logger = logger;
        ...
        {
            logger.Information("SDA processed");
